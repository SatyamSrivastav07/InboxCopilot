...
export default function PublicHomePage() {
  return (
    <div className="mx-auto max-w-6xl px-5 py-12 sm:px-8 sm:py-20">
      <section className="grid gap-10 rounded-3xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-sky-50 p-8 shadow-sm md:grid-cols-[1.35fr_0.65fr] md:p-12">
        <div>
        ...
        <aside className="rounded-2xl border border-indigo-100 bg-white/90 p-6 text-sm shadow-sm">
